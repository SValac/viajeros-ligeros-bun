...
const categoryProviders = computed(() => providerStore.getProvidersByCategory(PROVIDER_CATEGORY.HOSPEDAJE));
    ...
    <UCard>
      <div v-if="providers.length === 0" class="text-center py-12">
        ...
        <template v-else>
          ...
          <p class="text-gray-500 dark:text-gray-400 mb-4">
            Comienza agregando tu primer proveedor de hospedaje
          </p>
    ...
    >
      <template #body>
        <ProviderForm
          ...
          :fixed-categoria="PROVIDER_CATEGORY.HOSPEDAJE"
