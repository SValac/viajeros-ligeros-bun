...
const categoryProviders = computed(() => providerStore.getProvidersByCategory(PROVIDER_CATEGORY.COMIDAS));
...
function handleFormSubmit(data: ProviderFormData) {
  try {
    data.categoria = PROVIDER_CATEGORY.COMIDAS;
    ...
    >
      <template #body>
        <ProviderForm
          ...
          :fixed-categoria="PROVIDER_CATEGORY.COMIDAS"
