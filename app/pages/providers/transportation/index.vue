...
const categoryProviders = computed(() => providerStore.getProvidersByCategory('transporte'));
...
const columns: TableColumn<Provider>[] = [
  {
    ...
    cell: ({ row }) =>
      h('div', { class: 'flex items-center gap-2' }, [
        h('span', { class: 'i-lucide-car w-4 h-4 text-gray-400' }),
  ...
  <div class="space-y-6">
    <div class="flex justify-between items-center">
      <div class="flex items-center gap-4">
        <UIcon name="i-lucide-car" class="w-10 h-10 text-purple-500" />
        <div>
    ...
    <UCard>
      <div v-if="providers.length === 0" class="text-center py-12">
        <UIcon name="i-lucide-car" class="w-16 h-16 text-gray-300 dark:text-gray-600 mx-auto mb-4" />
        ...
        <template v-else>
          <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">
            No hay proveedores de transporte registrados aún
          </h3>
          <p class="text-gray-500 dark:text-gray-400 mb-4">
            Comienza agregando tu primer proveedor de transporte
          </p>
    ...
    <UModal
      ...
      :title="editingProvider ? 'Editar Transporte' : 'Nuevo Transporte'"
